 ...
 */
public class partyTypeAdapter extends ArrayAdapter<Sales> {
    ...
    public partyTypeAdapter(Context context, int textViewResourceId,
                        Sales[] values) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        label.setText(values[position].getStrPartyType());
    ...
    public View getDropDownView(int position, View convertView,
        ...
        TextView label = new TextView(context);
        label.setTextColor(Color.BLACK);
        label.setText(values[position].getPartyName() + "");
